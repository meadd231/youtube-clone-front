...
export const HomeOffIcon = (props) => (
  <svg
...
export const LikeOnIcon2 = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 270 270"
    width="270"
  ...
  >
    ...
    <g clip-path="url(#__lottie_element_125)">
      <g clip-path="url(#__lottie_element_141)" style="display: none;">
...
export const LikeOffIcon = (props) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    preserveAspectRatio="xMidYMid meet"
...
export const DislikeOnIcon = (props) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    preserveAspectRatio="xMidYMid meet"
...
export const DislikeOffIcon = (props) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    preserveAspectRatio="xMidYMid meet"
